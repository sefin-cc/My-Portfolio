  ...
  return (
    <div className="relative min-h-screen  overflow-hidden bg-(--color-white) w-full">
      ...
      />
        ...
        className="relative border-[--color-dark] border-4 rounded-3xl mx-4 md:mx-20 my-10 md:my-20 p-4 md:p-7 text-[--color-dark] flex flex-col md:flex-row justify-center items-center gap-6"
      ...
      >
        ...
        <div className="pl-0 md:pl-7 px-2 md:px-0">
          ...
          {[
            "I am tech-savvy and creative with a Bachelor of Science in Information Technology (with honors), majoring in System Development. With firsthand experience in using tools such as Figma, Photoshop, and Illustrator, I straddle the divide between development and design.",
            ...
            <motion.p
              ...
              className="mt-4 text-sm md:text-md max-w-xl leading-relaxed text-justify"
            >
              {text}
            </motion.p>
          ))}
